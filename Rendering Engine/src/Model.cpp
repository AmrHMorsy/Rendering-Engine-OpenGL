...
//{10.0f, 5.5, -5.0f}
Model::Model( glm::mat4 v, glm::mat4 proj, glm::vec3 c, progressbar * b, std::vector<std::string> texture_paths, std::string file_path, glm::mat4 lightproj, glm::mat4 lightview ): num_progress_bars(10), light_position({10.0f, 10.0f, -5.0f}), light_color({500.0f, 500.0f, 500.0f}), view(v), projection(proj), camera(c), file_paths(texture_paths), number_sand_patches(0), bar(b), lightprojection(lightproj), light_view(lightview)
{
